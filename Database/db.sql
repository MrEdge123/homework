...
INSERT INTO `course` VALUES ('001001','C语言程序设计',48,4),('001002','计算机导论',16,2),('001003','数字逻辑EDA',36,3),('001004','数据结构',48,5),('001005','计算机网络',48,5),('001006','计算机组成原理',48,5),('004001','高等数学',88,5.5),('004002','线性代数',48,2);
...
INSERT INTO `sdept` VALUES ('001','计算机学院','计算机学院的简介'),('002','自动化学院','自动化学院'),('003','材料与能源学院','材料与能源学院的简介'),('004','数学学院','数学学院'),('005','土木工程学院','土木工程学院');
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `student_ibfk_1` FOREIGN KEY (`no`) REFERENCES `user` (`no`) ON DELETE CASCADE,
...
INSERT INTO `student` VALUES ('20210001','小明','男','2001-04-05',550,'001'),('20210002','学生2','女','2000-01-01',560,'001'),('20210003','学生3','男',NULL,570,'001'),('20210004','学生4','女',NULL,580,'001'),('20210005','学生5','男',NULL,590,'001'),('20210006','学生6','男','2001-03-02',555,'002'),('20210007','学生7','男','2000-01-01',560,'002');
...
CREATE TABLE `student_course` (
  ...
  KEY `student_course_ibfk_2` (`tc_no`),
  CONSTRAINT `student_course_ibfk_1` FOREIGN KEY (`student_no`) REFERENCES `student` (`no`) ON DELETE CASCADE,
  CONSTRAINT `student_course_ibfk_2` FOREIGN KEY (`tc_no`) REFERENCES `teacher_course` (`no`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `teacher` (
  ...
  PRIMARY KEY (`no`),
  KEY `sdept_no` (`sdept_no`),
  CONSTRAINT `teacher_ibfk_1` FOREIGN KEY (`no`) REFERENCES `user` (`no`) ON DELETE CASCADE,
...
CREATE TABLE `teacher_course` (
  ...
  KEY `teacher_course_ibfk_2` (`teacher_no`),
  CONSTRAINT `teacher_course_ibfk_1` FOREIGN KEY (`course_no`) REFERENCES `course` (`no`),
  CONSTRAINT `teacher_course_ibfk_2` FOREIGN KEY (`teacher_no`) REFERENCES `teacher` (`no`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `teacher_course` VALUES ('0210010010','001001','20211001','2021年上','周三3,4节','教1-205','2021-06-08 16:05:00'),('0210010011','001002','20211001',NULL,NULL,NULL,NULL),('0210010012','001004','20211001',NULL,NULL,NULL,NULL),('0210010020','001002','20211002','2021年上','周二3,4节','教2-304','2021-06-11 16:05:00'),('0210010030','001003','20211002','2021年上','周一6,7节','教4-405',NULL),('0210010040','001004','20211003','2021年上','周四6,7节','教5-310',NULL),('0210010050','001005','20211004','2021年上','周五1,2节','教3-210',NULL),('0210040010','004001','20211005','2021年上','周五6,7节','教3-105',NULL);
...
INSERT INTO `user` VALUES ('00000000','admin','管理员'),('20210001','123456','学生'),('20210002','123456','学生'),('20210003','123456','学生'),('20210004','123456','学生'),('20210005','123456','学生'),('20210006','123456','学生'),('20210007','123456','学生'),('20210008','123456','学生'),('20211001','123456','老师'),('20211002','123456','老师'),('20211003','123456','老师'),('20211004','123456','老师'),('20211005','123456','老师');
...
/*!50001 VIEW `course_view` (`no`,`name`,`no_name`) AS select `course`.`no` AS `no`,`course`.`name` AS `name`,concat(`course`.`no`,' (',`course`.`name`,')') AS `concat(no, " (",  name, ")")` from `course` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `student_view` (`no`,`name`,`no_name`) AS select `student`.`no` AS `no`,`student`.`name` AS `name`,concat(`student`.`no`,' (',`student`.`name`,')') AS `concat(no, " (", name, ")")` from `student` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `teacher_view` (`no`,`name`,`no_name`) AS select `teacher`.`no` AS `no`,`teacher`.`name` AS `name`,concat(`teacher`.`no`,' (',`teacher`.`name`,')') AS `concat(no, " (", name, ")")` from `teacher` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-01-14 22:40:12
